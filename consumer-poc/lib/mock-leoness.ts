...
export const leoness: ConsumerWinery = {
  ...
  domains: {
    wine: {
      summary: 'Estate-focused wine program with a strong red-wine identity.',
      highlights: ['Estate wines', 'Hosted tastings', 'Tours'],
      lastVerified: null
    },
    food: {
      summary: 'A full restaurant experience makes Leoness a legitimate meal stop, not just a tasting room.',
      highlights: ['Full restaurant', 'Terrace dining', 'Sunday brunch'],
      lastVerified: null
    },
    experiences: {
      summary: 'The strongest fit is an unhurried visit that combines wine, views, and dining.',
      highlights: ['Vineyard views', 'Tours', 'Golden-hour appeal']
    },
    events: {
      summary: 'Live music, brunch, and seasonal programming can materially shape the visit.',
      highlights: ['Live music', 'Sunday brunch', 'Seasonal events']
    },
    accessibility: null,
    policies: null,
    hospitality: null,
  ...
  planning: {
    hours: null,
    reservations: 'Recommended for dining, tours, and larger groups.',
    visitLength: '2–3 hours',
    groups: 'Plan ahead for groups.',
    bestTime: 'Weekday afternoon or golden hour.'
  },
  editorial: {
  ...
  actions: {
    directionsUrl: 'https://maps.google.com/?q=Leoness+Cellars+Temecula',
    reservationUrl: 'https://leonesscellars.com/',
    eventsUrl: 'https://leonesscellars.com/events/calendar/'
  },
  freshness: {
